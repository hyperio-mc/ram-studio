...
const PROMPT = 'Freelance financial OS for solo creatives. Inspired by Midday.ai (darkmodedesign.com) + New Genre Studio (minimal.gallery). Light theme, copper accents, 6 screens.';
...
async function run() {
  ...
  console.log('Gallery queue updated:', putRes.status === 200 ? 'OK' : putRes.status, putRes.body.slice(0,100));
}
