// render-breakdown.mjs
// Renders DRIFTWOOD breakdown to MP4 using Remotion + local ffmpeg
// Usage: node render-breakdown.mjs
...
const bundled = await bundle({
  entryPoint: path.join(__dirname, 'remotion-breakdown/Root.jsx'),
...
const outPath = path.join(__dirname, 'driftwood-breakdown.mp4');
