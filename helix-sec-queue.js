...
const ARCHETYPE = 'developer-security-ai';
const PROMPT    = 'Dark AI security intelligence dashboard for engineering teams — deep space navy + electric violet inspired by Evervault (godly.website) and VAST SOTD (awwwards)';
...
(async () => {
  ...
  const newEntry = {
    ...
    inspired_by:  'Evervault (godly.website), VAST SOTD (awwwards), Neon.tech (darkmodedesign)',
  };
