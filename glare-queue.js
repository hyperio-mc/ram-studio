...
const SLUG      = 'glare';
const APP_NAME  = 'GLARE';
const TAGLINE   = 'Creator intelligence, amplified';
const ARCHETYPE = 'creator-analytics';
const PROMPT    = 'Creator analytics OS: true-black dark UI with electric chartreuse glowing data visualizations, inspired by Neon on darkmodedesign.com. 6 screens: Command dashboard, Reach analytics, Revenue intelligence, Content performance, Signals, Profile.';
