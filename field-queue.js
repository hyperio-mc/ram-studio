...
const ARCHETYPE  = 'fieldwork-journal';
const PROMPT     = 'Biophilic light-theme fieldwork journal app. Inspired by Minimal Gallery barely-there UI trend and Land-book Big Type pattern. Warm cream palette, bold serif headlines, visible border structure, 6 screens.';
const ELEMENTS   = 615;
