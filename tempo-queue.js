...
const ARCHETYPE = 'intelligence-briefing';
const PROMPT    = 'Inspired by useformat.ai/podcasts (featured on Dark Mode Design): AI converts business data into personalized audio briefings. Deep midnight navy dark theme, editorial typography, waveform visualisations, category-based intelligence channels.';
...
(async () => {
  ...
  if (putRes.status === 200) console.log('Entry added:', newEntry.id);
})();
