...
const ARCHETYPE = 'material-discovery';
const ORIGINAL_PROMPT = 'Material discovery & specification platform for architects and interior designers. Inspired by darkmodedesign.com geological texture trend (SaltBits, Mortons) and minimal.gallery editorial dark UI. Dark theme: deep charcoal, warm amber, natural material textures.';
