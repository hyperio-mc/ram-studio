...
const ARCHETYPE = 'sprint-intelligence';
const PROMPT   = 'Light editorial sprint health + retrospective intelligence app. Warm cream palette, forest green accent, AI-powered team insights. 5 screens: Sprint Overview, Team Pulse, Velocity Trends, Actions, Team Health.';
...
async function main() {
  ...
  const newEntry = {
    ...
    source: 'heartbeat',
    theme: 'light',
    palette: { bg:'#F8F5EF', accent:'#2D6A4F', accent2:'#F4A261' },
  };
