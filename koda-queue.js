...
async function main() {
  ...
  const putBody = JSON.stringify({
    message: `add: ${APP_NAME} to gallery (heartbeat #501)`,
    content: newContent,
    sha: currentSha,
  });
