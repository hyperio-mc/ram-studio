...
async function main() {
  ...
  const pen = JSON.parse(fs.readFileSync('/workspace/group/design-studio/scope2.pen','utf8'));
  ...
  queue.submissions.push({
    ...
    prompt: 'Developer observability platform inspired by darkmodedesign.com 2026 orange glow accent trends and Saaspo command palette patterns. Dark cinematic theme.',
    screens: 6,
  ...
  const putBody = JSON.stringify({
    message: 'add: SCOPE to gallery (heartbeat #20)',
    content: newContent,
    sha,
  });
