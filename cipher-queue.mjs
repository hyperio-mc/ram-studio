...
const PROMPT    = 'Dark security ops app for developer teams — inspired by Codegen.com near-black UI and Evervault deep navy + Tracebit "Assume Breach" framing. 5 screens: dashboard, live scan, vulnerabilities, threat feed, integrations. Cyan-mint accent on near-black deep navy.';
