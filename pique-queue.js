...
const ARCHETYPE = 'fashion-curation';
const PROMPT = 'Light editorial mobile app with floating annotation hotspot pins over fashion photography. Inspired by Overlay (lapa.ninja). Warm ivory palette with terracotta accent and sage green. 5 screens: Discover, Item Detail, Wardrobe, Style Profile, Outfit Builder.';
