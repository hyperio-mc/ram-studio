...
async function main() {
  const heroHtml = fs.readFileSync('/workspace/group/design-studio/murmur-hero.html', 'utf8');
  ...
  const penJson = fs.readFileSync('/workspace/group/design-studio/murmur.pen', 'utf8');
