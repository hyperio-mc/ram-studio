...
const SLUG      = 'sol';
const APP_NAME  = 'Sol';
const TAGLINE   = 'Know your energy. Own your day.';
const ARCHETYPE = 'wellness-ai';
const PROMPT    = 'Design a warm light-mode AI personal energy and morning ritual app. Inspired by Dawn AI (Landbook), Fluid Glass (Awwwards), and Darkroom.au precision aesthetics.';
