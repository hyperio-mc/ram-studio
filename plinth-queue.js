...
const PROMPT     = 'Design a personal finance OS using asymmetric bento grid cards inspired by Saaspo bento category and minimal.gallery warm cream aesthetic, with serif display typography as a counter to the Inter monoculture';
